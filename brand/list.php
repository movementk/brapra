...
<body>
    ...
    <main id="content" class="sub brand"><!-- 대메뉴 또는 소메뉴별 클래스가 필요할 경우 이곳에 작성 -->
        <!-- 작업 영역 -->
        <div class="top-visual brand">
            <div>
                <div class="container">
                    <h2 class="visual-title"><img src="/design/brapra/images/brand/txt_wonderbra.png" alt="Wonderbra"></h2>
                </div>
            </div>
        </div>
