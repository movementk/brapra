...
<body>
    ...
    <main id="content" class="sub mypage myprd">
        <!-- 작업 영역 -->
        ...
        <div class="container">
            ...
            <ul class="nav nav-mypage mb40">
                ...
                <li class="active"><a href="/mypage/myprd.php">최근 본 상품목록</a></li>
            ...
            <table class="table table-thumlist">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>59,900원</td>
                        <td>
                            <a href="#" class="btn btn-bo btn-bg">담기</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="btn-area pull-right mb10">
                <a href="#" class="btn btn-sm btn-d" >선택삭제</a>
            </div>
