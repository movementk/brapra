...
<main class="content">
    ...
    <div class="container">
         <article class="product-list list-tab2">
             <div class="dropdown">
            ...
            <ul class="row list">
                <li class="col-xs-6">
                    <a href="#">
                        <p class="item">
                            <img src="/design/brapra/mobile/images/product_list/product01.jpg" class="img-responsive" alt="제품 이미지">
                        </p>
                        <div class="details">
                            <p class="title">
                                컴포트 누디 노와이어 핑크<br>
                ...
                <li class="col-xs-6">
                    <a href="#">
                        <p class="item">
                            <img src="/design/brapra/mobile/images/product_list/product02.jpg" class="img-responsive" alt="제품 이미지">
                        </p>
                        <div class="details">
                            <p class="title">
                                컴포트 누디 노와이어 딥핑크<br>
                ...
                <li class="col-xs-6">
                    <a href="#">
                        <p class="item">
                            <img src="/design/brapra/mobile/images/product_list/product03.jpg" class="img-responsive" alt="제품 이미지">
                        </p>
                        <div class="details">
                            <p class="title">
                                컴포트 누디 노와이어 아이보리<br>
                ...
                <li class="col-xs-6">
                    <a href="#">
                        <p class="item">
                            <img src="/design/brapra/mobile/images/product_list/product04.jpg" class="img-responsive" alt="제품 이미지">
                        </p>
                        <div class="details">
                            <p class="title">
                                컴포트 누디 노와이어 핑크<br>
